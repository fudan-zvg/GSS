_base_=['bigseg_cityscapes_conns_swin_80k_025_dim_768_2048_wo_cpm_bs2x16_transformer_right_color_lr.py']
...
model=dict(
    ...
    num_classes=19,
    palette=PALETTE,
    load_dir = 'work_dirs/bigseg_cityscapes_conns_swin_80k_025_dim_768_2048_wo_cpm_bs2x16_transformer_right_color_lr/indice_iter_80000/val/'
    # backbone=dict(
    #     _delete_=True,
