_base_ = [
    '../_base_/models/bigseg_relax_e08_hunger.py', '../_base_/datasets/nyu_depth_v2.py',
...
model = dict(
    backbone=dict(
        ...
        patch_norm=True),
    decode_head=dict(
        type='BigSegAggHeadWoCPMTransformerDepth',
        ...
        loss_decode=[
            ...
            dict(type='MSELossDepth', loss_name='loss_mse_pixel', loss_weight=0.2)
        ]
    )
)
