_base_ = [
    '../_base_/models/mask_vq_seg_agg_relax_e08_hunger_dual_loss.py', '../_base_/datasets/cityscapes_for_vqseg_768x768.py',
...
model = dict(
    ...
    decode_head=dict(num_classes=19,
                     loss_decode=dict(
                         type='IndiceCrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, sparse_weight=0.6)
                     ))
