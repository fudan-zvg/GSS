...
# mapillary_public_65_train, # 18k, 14 times, additional iter
...
times = {
    'ade20k_150': 6,
     ...
     'coco_panoptic_133': 1,
     'idd_39': 17,
     'mapillary_public_65': 7, # not change here
     'sunrgbd_37': 24
}
...
cityscapes_19_val = dict(
    ...
    ann_dir='gtFine_19cls_relabeled/val',
    img_suffix='_leftImg8bit.png',
    seg_map_suffix='_gtFine_labelIds.png',
...
train_data_list = [
    ...
    coco_panoptic_133_train,    # 118k,     1 times
    idd_39_train,               # 7k,       17 times
    mapillary_public_65_train,  # 18k,      7 times, first time
    sunrgbd_37_train,           # 5k,       24 times
    # Additional mapillary iters for better driving scenes performance.
    mapillary_public_65_train,  # 18k,      7 times, repeat one more time
]
...
test_data_list = [          # 12215
    voc2012_test,           # 1449
    pascal_context_60_test, # 5105
    camvid_11_test,         # 101
    wilddash_19_test,       # 70
    kitti_19_test,          # 50
    scannet_20_test         # 5440
]
