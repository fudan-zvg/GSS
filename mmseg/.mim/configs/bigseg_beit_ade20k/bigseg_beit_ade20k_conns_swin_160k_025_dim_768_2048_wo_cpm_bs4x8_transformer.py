_base_ = [
    '../_base_/models/bigseg_beit.py', '../_base_/datasets/ade20k_for_vqseg.py',
    '../_base_/default_runtime.py', '../_base_/schedules/schedule_160k.py'
]
norm_cfg = dict(type='SyncBN', requires_grad=True)
# checkpoint_file = '/home/chenjiaqi/pj/mmsegmentation/ckp/beit_large_patch16_224_pt22k_ft22k.pth'
...
model = dict(
    pretrained='ckp/beit_large_patch16_224_pt22k_ft22k.pth',
    backbone=dict(
        type='BEiT',
        embed_dims=1024,
        num_layers=24,
