...
from beit2_finetune import VisionTransformer
...
class VQKD(nn.Module):
    ...
    def get_quantized_vector(self, x, **kwargs):
...
if __name__ == '__main__':
    model = vqkd_encoder_base_decoder_3x768x12_clip(pretrained=True,
                                                    pretrained_weight='pretrain/vqkd_encoder_base_decoder_1x768x12_clip-d93179da.pth')
    x = torch.rand(1, 3, 224, 224)
    y = model.get_quantized_vector(x)
    print(y)
