...
class BigSegAggHeadRelaxE08HungerLocal(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 palette=None,
                 **kwargs):
        super(BigSegAggHeadRelaxE08HungerLocal, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
        ...
        # local
        self.vq_local_conv = nn.Sequential(
            ConvModule(
