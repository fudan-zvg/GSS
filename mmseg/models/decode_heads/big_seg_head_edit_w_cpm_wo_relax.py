...
class BigSegAggHeadHungerEdit(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(BigSegAggHeadHungerEdit, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
    ...
    def forward_train(self, inputs, img_metas, gt_semantic_seg, train_cfg):
        ...
        with torch.no_grad():
            ...
            # get do not relaxed correct pixel mask (CPM)
