...
class BigSegAggHeadWoCPMTransformerMask(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 swin_window_size=7,
                 **kwargs):
        super(BigSegAggHeadWoCPMTransformerMask, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
    ...
    def losses(self,
        ...
        extended_mask = recon_mask.repeat_interleave(int(ori_img.shape[1]/recon_mask.shape[1]),dim = 1).unsqueeze(-1).expand_as(ori_img)
