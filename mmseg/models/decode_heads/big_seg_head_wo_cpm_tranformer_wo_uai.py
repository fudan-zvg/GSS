...
class BigSegAggHeadWoCPMTransformerUAI(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 swin_window_size=7,
                 **kwargs):
        super(BigSegAggHeadWoCPMTransformerUAI, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
    ...
    def forward_train(self, inputs, img_metas, gt_semantic_seg, train_cfg):
        ...
        losses = self.losses(indice_seg_logit=vq_logits,
                             indice_seg_label=gt_semantic_seg_indices)
        return losses
