...
class MaskVQSegAggHead_w_bigger_ignore_wo_things(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(MaskVQSegAggHead_w_bigger_ignore_wo_things, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
    ...
    def get_ignore_mask(self, gt_semantic_seg, gt_vq_indices):
        ...
        # w_bigger_ignore wo_things 中去掉这个things的防腐蚀
