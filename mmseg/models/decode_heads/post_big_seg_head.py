...
class PostBigSegAggHeadRelaxE08Hunger(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 palette=None,
                 **kwargs):
        super(PostBigSegAggHeadRelaxE08Hunger, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
    ...
    def forward_test(self, inputs, img_metas, gt_semantic_seg, test_cfg):
        with torch.no_grad():
            ...
            #     torch.float)
            # save_image(self.encode_to_segmap(gt_semantic_seg[0]) /255.0,
            #            'work_dirs/visualization_stage_2/cityscapes_learnable/' +
