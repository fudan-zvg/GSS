...
class PostBigSegAggHeadRelaxE08HungerConv3(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 palette=None,
                 **kwargs):
        super(PostBigSegAggHeadRelaxE08HungerConv3, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
    ...
    def forward_test(self, inputs, img_metas, gt_semantic_seg, test_cfg):
        ...
        seg_logist = self.cls_segmap(rec_segmap)
