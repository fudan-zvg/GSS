...
class PostBigSegAggHeadRelaxE08HungerConv3_5x5D256(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 palette=None,
                 **kwargs):
        super(PostBigSegAggHeadRelaxE08HungerConv3_5x5D256, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
