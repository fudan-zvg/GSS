...
class VQSegAggHead(BaseDecodeHead):
    """
    Args:
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(VQSegAggHead, self).__init__(init_cfg=init_cfg, input_transform='multiple_select', channels=channels, **kwargs)
    ...
    def _forward_train_seg_with_dalle(self, inputs, gt_semantic_seg, img_metas):
        ...
        with torch.no_grad():
            ...
            # ignore_map[gt_semantic_seg >= self.num_classes] = 1
