...
class VQVAEHeadTransformerSwinNonUnlable(BaseDecodeHead):
    def __init__(self,
                 stage,
                 num_classes,
                 channels=256,
                 ...
                 # code_len=256,
                 **kwargs):
        super(VQVAEHeadTransformerSwinNonUnlable, self).__init__(channels=channels, in_channels=3, num_classes=num_classes,**kwargs)
    ...
    def forward(self, img, gt_semantic_seg):
        ...
        if self.train_mode:
            ...
            z_q= F.dropout(z_q,p,inplace = True,training =self.train_mode)*(1-p)
