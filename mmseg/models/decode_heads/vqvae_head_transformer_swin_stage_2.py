...
class VQVAEHeadTransformerSwinStage2(BaseDecodeHead):
    def __init__(self,
                 stage,
                 num_classes,
                 channels=256,
                 ...
                 # code_len=256,
                 **kwargs):
        super(VQVAEHeadTransformerSwinStage2, self).__init__(channels=channels, in_channels=3, num_classes=num_classes,**kwargs)
            ...
            if loss_decode.loss_name not in loss:
                ...
                if loss_decode.loss_name == 'loss_ce':
                    loss[loss_decode.loss_name] += loss_decode(
                        ...
                        weight=seg_weight,
                        ignore_index=self.ignore_index)
        loss['acc_seg'] = accuracy(z_logit, z_label, ignore_index=self.ignore_index)
