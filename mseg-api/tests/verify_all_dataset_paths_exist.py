...
def visual_sanitychecks():
    ...
    for dname, d_info in infos.items():
        ...
        if dname in ['ade20k-151-inst', 'ade20k-151', 'ade20k-150', 'ade20k-150-relabeled', 'bdd',
                     'bdd-relabeled', 'camvid-11', 'cityscapes-34', 'cityscapes-19', 'cityscapes-19-relabeled',
                     'idd-40', 'cityscapes-34-relabeled', 'coco-panoptic-201', 'coco-panoptic-133-relabeled',
                     'idd-39', 'idd-39-relabeled', 'kitti-34', 'kitti-19', 'mapillary-public66',
                     'mapillary-public65', 'mapillary-public65-relabeled', 'pascal-context-460',
                     'pascal-context-60', 'scannet-41', 'scannet-20', 'sunrgbd-38', 'sunrgbd-37',
                     'sunrgbd-37-relabeled', 'voc2012', 'coco-panoptic-133']:
            continue
